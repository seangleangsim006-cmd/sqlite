...
class DbHepler {
  ...
  // Insert
  static Future<int> insertNote(String Position, String Skill, String Category, String Date)async{
   final db = await openDB();
   return db.insert('note', {'position':Position, 'skill':Skill,'category':Category,'date':Date});
  }
